<template>
    <v-container fluid>
        ...
        <v-row align="center" justify="start" class="mb-0">
            <v-col md="8" offset-md="1" offset-lg="1" lg="8" sm="11" cols="12">
                <p class="google-font mb-1" style="font-weight: 350;font-size:200%"><b>Our
                    <span style="color: #1a73e8;">Communities</span> </b> 
                </p>
        ...
        <v-row align="center"  justify="center" class="mt-0 ma-10">
            <v-col align="center" cols="12" md="12" lg="12" sm="12" class="mx-0 mt-0">
